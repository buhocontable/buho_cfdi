RSpec.describe Nodes::Receipt, type: :model do
  ...
  it { should respond_to(:payment_conditions) }
  ...
  describe '#to_hash' do
    ...
    it 'is expected to include xsi:schemaLocation' do
      expect(subject.to_hash).to include('xsi:schemaLocation')
    end
  end
end